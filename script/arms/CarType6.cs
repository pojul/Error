...
public class CarType6 : PojulObject {
	...
	void Start () {
		...
		transform_lod0 = transform.Find ("car_type6_lod0");
		transform_lod1 = transform.Find ("car_type6_lod1");
		transform_lod2 = transform.Find ("car_type6_lod2");
